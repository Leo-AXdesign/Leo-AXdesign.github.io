...
PAGE_META = {
    ...
    "asset":     ("assets",    "아이콘·일러스트·에셋 사이트 {n}곳", "아이콘, 일러스트, 사진, 영상 등 디자인 에셋을 받을 수 있는 곳입니다."),
    "mockup":    ("mockups",   "디자인 목업 사이트 {n}곳",      "기기·인쇄물·패키지·의류 목업과 목업 생성기를 모았습니다. 무료 PSD부터 3D·영상 목업까지."),
