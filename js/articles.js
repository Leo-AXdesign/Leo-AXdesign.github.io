...
const ARTICLES = [
  { slug: "claude-code-and-gpt-6-astra", title: "코드 한 줄 직접 쓰지 않고 사이트를 만들었다", desc: "클로드 코드로 이 사이트를 만들면서 알게 된 것, 그리고 이번 달 나온 GPT-6 아스트라를 디자이너 자리에서 본 이야기.", date: "2026-09-26", tag: "AI 디자인", min: 3 },
